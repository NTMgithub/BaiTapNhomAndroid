...
public class InfoNational extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetInfoNational().execute("http://api.geonames.org/countryInfoJSON?username=btandroid2");
            ...
            try {
                ...
                for (int i = 0; i < jsonGeonames.length(); i++){
                    ...
                    if ( countryName.equals(nationalName) ){
                        ...
                        tvDanSo.setText(object.getString("population") + " người");
                        tvDienTich.setText(object.getString("areaInSqKm") + " km2");
